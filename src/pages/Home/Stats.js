...
const Stats = () => {
    return (
        <section className="p-4 my-6 md:p-8 bg-red-500 text-gray-100">
            <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
                <div className="flex overflow-hidden rounded-lg bg-orange-300 text-gray-800">
                    <div className="flex items-center justify-center px-4 bg-white text-gray-800">
